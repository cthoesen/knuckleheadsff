...
import { Flame, ArrowLeft, ArrowLeftRight, Calculator, TrendingUp, Users, FileText, Swords } from 'lucide-react';
    ...
    <div className="min-h-screen cyber-bg">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          ...
          <a href="/docs/bsb/bsb-bylaws.pdf" target="_blank" rel="noopener noreferrer">
            <div className="tool-card group">
              <div className="flex items-start gap-4">
                <div className="p-3 bg-rose-500/10 rounded-lg group-hover:bg-rose-500/20 transition-colors">
