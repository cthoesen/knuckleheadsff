  ...
  return (
    <>
      ...
      <div className="league-kkl" style={{ position: 'relative', zIndex: 1, fontFamily: 'var(--font-body)' }}>
        <ToolHeader code="KKL" kicker="KKL · COMMISSIONER TOOL" title="Trade Analyzer" backHref="/kkl" backLabel="KKL Hub" />
              ...
              <div style={{
                ...
                <div>
                  ...
                  <div style={{
                    ...
                    fontWeight: 900,
                    fontSize: '1rem',
                    borderTop: '2px solid rgba(31, 182, 255, 0.3)',
                    marginTop: '0.5rem',
                  }}>
...
function posColor(pos: string) {
  switch (pos) {
    ...
    case 'PK': return 'var(--kff-ink)';
    case 'Def': return 'var(--kff-violet)';
    default: return 'var(--kff-ink-mute)';
  }
}
...
function TeamPanel({
  ...
  return (
    <div style={{
            ...
            {sortedPlayers.map(player => {
              ...
              return (
                <tr
                  ...
                  style={{
                    borderTop: '1px solid rgba(31, 182, 255, 0.08)',
                    cursor: 'pointer',
                    background: selected ? 'rgba(31, 182, 255, 0.1)' : 'transparent',
                    transition: 'background-color 0.15s',
                  }}
                  onMouseEnter={e => { if (!selected) e.currentTarget.style.background = 'rgba(31, 182, 255, 0.1)'; }}
                  onMouseLeave={e => { e.currentTarget.style.background = selected ? 'rgba(31, 182, 255, 0.1)' : 'transparent'; }}
                >
                  <td style={{
                    padding: '0.6rem 1rem',
      ...
      {/* Draft Picks Section */}
      <div style={{ borderTop: '1px solid rgba(31, 182, 255, 0.2)' }}>
        <button
