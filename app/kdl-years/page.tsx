...
export default function KDLYearsApp() {
  ...
  if (isLoading) return (
    <div className="min-h-screen cyber-bg flex items-center justify-center">
      <div className="text-[#a95ef5] font-mono animate-pulse text-xl">SCANNING ROSTERS...</div>
    </div>
  );
  ...
  return (
    <div className="min-h-screen league-kdl" style={{ background: 'var(--bg-base)' }}>
      <ToolHeader code="KDL" kicker="KDL · COMMISSIONER TOOL" title="Unassigned Years" backHref="/kdl" backLabel="KDL Hub" />
